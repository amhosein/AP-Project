...
public class Primary {
    ...
    private static void initHeroes() {
        ...
        Card BlackPearl = new Weapons("Black Pearl", 2, 2, 5, Rarity.Rare, "A Ship With Two Cannon", new ArrayList<>(Collections.singletonList(Abilities.Echo)));
        Hero.setSpecialCard(JackSparrow, BlackPearl);
        Card MonkeyJack = new Spell("Monkey Jack", 3, 1, 0, Rarity.Rare, "Discover a Weapon From Any Class and Add it to Your Adventure", new ArrayList<>(Collections.singletonList(Abilities.Discover)));
        Hero.setSpecialCard(JackSparrow, MonkeyJack);

        Card ZeusFury = new Spell("Zeus Fury", 2, 1, 6, Rarity.Rare, "Zeus Can Throw Two Thunder and Lightening", new ArrayList<>(Collections.singletonList(Abilities.TwinSpell)));
        Hero.setSpecialCard(Zeus, ZeusFury);
        Card GodMerci = new Weapons("Gods Merci", 2, 1, 1, Rarity.Rare, "Zeus Heal His Crew and Attack His Enemies", new ArrayList<>(Collections.singletonList(Abilities.TwinSpell)));
        ...
        Card TsubaMother = new Spell("Tsubasa Ozara's Mother", 3, 1, 0, Rarity.Rare, "She Can flirt With One Minion And convince It Not To Fight With U", new ArrayList<>(Collections.singletonList(Abilities.Poisonous)));
    ...
    private static void initCards() {
        allCards.add(new Minions("Pintel and Ragetti", 2, 2, 2, Rarity.Common, "These Tow Wear Women Clothes So it Takes on Turn To Enemies Recognise Them", new ArrayList<>(Collections.singletonList(Abilities.DivineShield))));
        ...
        allCards.add(new Minions("Captian Barbosa", 3, 3, 3, Rarity.Common, "He Can Reborn", new ArrayList<>(Collections.singletonList(Abilities.Reborn))));

        allCards.add(new Minions("Sergio Ramos", 4, 7, 3, Rarity.Common, "Good Defence For Your Hero ", new ArrayList<>(Collections.singletonList(Abilities.Taunt))));
        allCards.add(new Minions("Tachibana Twins", 1, 2, 2, Rarity.Rare, "You Can Play Twins Tachibana ", new ArrayList<>(Collections.singletonList(Abilities.DoubleCard))));
        ...
        allCards.add(new Minions("Donya JavanBakht", 1, 5, 5, Rarity.Legendary, "As she Has Nice Bo em .. Nice Moral So All of Enemies Try To Flirt with Her so You can Play Cards 2 Turn In Raw", new ArrayList<>(Collections.singletonList(Abilities.TowTurn))));
        allCards.add(new Minions("Amir Tataloo", 1, 1, 1, Rarity.Common, "Just Kill Him !", new ArrayList<>()));
        allCards.add(new Minions("Amber Heard", 1, 2, 2, Rarity.Common, "She Will Divorce Enemies Hero After She Died", new ArrayList<>(Collections.singletonList(Abilities.DeathRattle))));
